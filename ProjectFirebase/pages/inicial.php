        ...
        <div class="col-md-12">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-purple">
              ...
              <!-- /.widget-user-image -->
              <h3 class="widget-user-username"><?php echo ucfirst($usuario['nome']);?></h3> 
            ...
            <div class="box-footer no-padding">
              <ul class="nav nav-stacked">
                <li><a href="home.php?page=ssh/contas">Contas <span class="pull-right badge bg-purple"><?php echo $quantidade_ssh; ?></span></a></li>
                <li><a href="home.php?page=usuario/listar">Clientes <span class="pull-right badge bg-green"><?php echo $quantidade_sub; ?></span></a></li>
                <li><a href="home.php?page=servidor/meuservidor">Servidores <span class="pull-right badge bg-yellow"><?php echo $acesso_servidor; ?></span></a></li>
