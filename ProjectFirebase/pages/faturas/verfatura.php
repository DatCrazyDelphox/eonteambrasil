    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> SSHPLUS, Inc.
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          De
          <address>
            <<strong>SSHPLUS, Inc.</strong><br>
            Aracaju, SE<br>
            Telefone: (79) 99879-0001<br>
            Email: crzvpn@gmail.com<br>
            Telegram: @crazy_vpn
         </address>
        </div>
        <!-- /.col -->
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          ...
          <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
           (Aceitamos Depósito e Transfêrencia• Bancaria na Conta da CAIXA Abaixo)<br />
           •Conta: 00001276-6 •Agencia: 3570 •Operação: 023 •Nome: Dimas ernandes (Após o pagamento enviar a confirmação com a print do comprovante.)
          </p>
        </div>
        <!-- /.col -->
        <div class="col-xs-6">
