...
<head>
  ...
  <meta name="theme-color" content="#565297">
  <title>Project Firebase | HOME </title>
 ...
 <!-- DataTables -->
  ...
  <!-- Messages: Respond.js doesn't work if you view the page via file:// -->
  <!--[if lt IE 9]>
...
<!-- =============================================== -->
   ...
   <header class="main-header">
    ...
    <a href="home.php" class="logo">
      ...
      <span class="logo-mini"><b>PFB</b></span>
				<span class="logo-lg">Project<b>Firebase</b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <a href="#"><i class="fa fa-circle text-success"></i> Online</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<small class="label pull-right bg-orange"><head><script type="text/javascript">function horas(){camada = document.getElementById('relogio');hoje = new Date();hora = hoje.getHours();if(hora<=9){hora = "0" + hora;}minuto = hoje.getMinutes();if(minuto<=9){minuto = "0" + minuto;}segundo = hoje.getSeconds();if(segundo<=9){segundo = "0" + segundo;}camada.innerHTML = hora + ":" + minuto + ":" + segundo;setTimeout("horas()",1000);}</script><style>#relogio{position: relative; /*tipo de posicionamento*/width: 50px; /*largura da DIV*/height: 10px; /border: 0px solid #ccc; /*borda da DIV*/text-align: center; /*alinhamento do texto*/</style></head><body onload="horas()"><div id="relogio"></div></body></small>
      ...
      <ul class="sidebar-menu">
        <li class="header"><font color="#FFF">NAVEGAÇÃO PRINCIPAL</font></li>
        ...
        <li class="treeview ">
         ...
         <li>
          <a href="?page=iptv">
            <i class="fa fa-television"></i> <span>IPTV</span>
             <span class="pull-right-container">
